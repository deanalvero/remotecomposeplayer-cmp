...
data class RcRowLayoutOperation(
    ...
    override val name: String = "RowLayout"
    ...
    override fun toString(): String {
        ...
        return "$name [ID: $componentId, AnimID: $animationId] -> Arrange(Horizontal): $hPos, Align(Vertical): $vPos$spacing"
    }
